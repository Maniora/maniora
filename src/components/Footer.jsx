...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Instagram, href: 'https://www.instagram.com/maniora.in/', label: 'Instagram' },
    { icon: YouTube, href: 'https://youtube.com/@maniora.official?si=8GATxM8g2yL-ansK', label: 'YouTube' },
    { icon: LinkedIn, href: 'https://www.linkedin.com/company/maniora-in/ ', label: 'LinkedIn' },
  ];

  const contactInfo = [
    { icon: Email, text: 'info@maniora.in', href: 'mailto:info@maniora.in', external: false },
