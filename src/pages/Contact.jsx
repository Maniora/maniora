...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Email,
      title: 'Email',
      value: 'maniora.official@gmail.com',
      href: 'mailto:maniora.official@gmail.com'
    },
    {
      icon: Phone,
      title: 'Phone',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const emailjsConfig = {
        serviceId: 'service_kpslu0y', // Replace with your EmailJS service ID
        templateId: 'template_b5h07r1', // Replace with your EmailJS template ID
        publicKey: 'laC67YVxzEdJdeZhD', // Replace with your EmailJS public key
      };
